...
const PHASES: Record<string, string[]> = {
  nour: ["تقرأ عقل العلامة…", "تحلّل نية البحث…", "تصوغ المخرج بعربية طبيعية…", "تراجع الجودة قبل التسليم…"],
  sonny: ["يقرأ نبرة علامتك…", "يدرس ما ينجح على المنصة…", "يصوغ منشوراً يوقف التمرير…", "يضبط الهاشتاقات والتوقيت…"],
